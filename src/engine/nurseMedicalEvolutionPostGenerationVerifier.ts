...
/**
 * PostGenerationVerifier for Nurse Medical Clinic Evolution (NURSE_EVOLUTION_MEDICAL_CLINIC).
 ...
 * 3. DeviceLock: Devices must strictly match AuthorizedDeviceRegistry.
 ...
 */
export function verifyNurseMedicalEvolutionAIRefinedResponse(
